---
title: hexo的搭建
date: 2021-09-23 19:33:51
tags: 
	- manjaro
categories: linux
mathjax: true
---
heox+github+sublime 搭建博客
<!--more-->
## 必备
nodejs，npm，git
```bash
...
如果下载失败设置代理
```bash
npm config set proxy http://xxx.x.x.x::port
...
# Site
title: The Seven Heaven
subtitle: ''
description: 一名科研狗的随手记
keywords:
author: marigold
language: zh-CN
timezone: ''
...
url: http://marigold0225.github.io
...
deploy:
  type: git
  repo: 
    github: git@github.com:marigold0225/marigold0225.github.io.git
  branch: master
...
social:
  GitHub: https://github.com/marigold0225 || fab fa-github
  E-Mail: mailto:mflovelky418@gmail.com || fa fa-envelope
...
math:
  ...
  mathjax:
    ...
    mhchem: false
    #cdn: //cdn.jsdelivr.net/npm/mathjax@2.7.8/unpacked/MathJax.js?config=TeX-MML-AM_CHTML
    cnd: https://cdn.jsdelivr.net/npm/mathjax@3/es5/tex-mml-chtml.js
  #  per_page: true
...
```
## 超级坑跌
折磨了我很久的东西，卸载原来的公式渲染marked，下载pandoc，换行用diplaylines：
```
$$
